...
import type { MediaError, MediaPage, SearchParams } from "@fotoowl/media-core";

import { useMediaClient } from "../context/MediaProvider.js";
...
export function useMediaSearch(params: SearchParams): UseMediaSearchResult {
  ...
  const loadMore = useCallback(async () => {
    if (loading || loadingMore || !data?.hasNextPage) {
      return;
    }
